                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                {
                                    (auth.user.has_underling==1) ? (<div className="hidden sm:flex sm:items-center sm:ml-6">
                                        <Dropdown>
                                            <Dropdown.Trigger>
                                ...
                                {
                                    (auth.user.is_admin==1) ? (<div className="hidden sm:flex sm:items-center sm:ml-6">
                                        <Dropdown>
                                            <Dropdown.Trigger>
                                                <span className="inline-flex rounded-md">
                                                    <button
                                            ...
                                            <Dropdown.Content>
                                                <Dropdown.Link href={route('master_aktivitas')} method="get" as="button">
                                                    Kelola Aktivitas
                                                </Dropdown.Link>
                                                <Dropdown.Link href={route('master_users')} method="get" as="button">
                                                    Kelola Pengguna
                                                </Dropdown.Link>
