...
import PegawaiAddActivitySpecificEnhancedTable from './Tables/PegawaiAddActivitySpecificEnhancedTable'

const PegawaiAddActivityTable = ({
  tableData,
  buktiFisikData,
  allUnsur,
  allRank
  ...
  return (
    <div>
      <CssBaseline />
      <PegawaiAddActivitySpecificEnhancedTable
        columns={columns}
        data={data}
        setData={setData}
...
export default PegawaiAddActivityTable
