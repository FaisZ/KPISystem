...
import PegawaiSubmittedActivitySpecificEnhancedTable from './Tables/PegawaiSubmittedActivitySpecificEnhancedTable'

const PegawaiSubmittedActivityTable = ({
  tableData,
  buktiFisikData,
  allUnsur,
  allRank
  ...
  return (
    <div>
      <CssBaseline />
      <PegawaiSubmittedActivitySpecificEnhancedTable
        columns={columns}
        data={data}
        setData={setData}
...
export default PegawaiSubmittedActivityTable
