...
class Aktivitas extends Authenticatable
{
    ...
    public function getFullActivity()
    {
        ...
        ->select('kpi_activity.id','kpi_group.id as unsur_id','kpi_group.title as unsur','kpi_activity.title AS aktivitas','rank.id AS jabatan_id','rank.name AS jabatan','credit_value as angkaKredit','tahapan.description AS tahapan')
